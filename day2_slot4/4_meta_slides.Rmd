...
.footnote[[1] See chapter 15 in Goodfellow, I, Y. Bengio and A. Courville (2016). Deep Learning.
...
- notebook: [eager_intro.Rmd](../eager_intro.Rmd)
- exercise: [4_meta_quizzes.Rmd](../4_meta_quizzes.Rmd)
...
We use `tfdatasets` to stream the data.
...
.pull-left[![](images/limecat1.png)]
.pull-right[![](images/limecat2.png)]
...
- notebook: [lime.Rmd](lime.Rmd) 
- notebook: [class_activation_maps.Rmd](class_activation_maps.Rmd) 
- exercise: [4_meta_quizzes.Rmd](4_meta_quizzes.Rmd)
...
.footnote[
[1] cf. Gal, Y. and Z. Ghahramani (2016). Dropout as a Bayesian Approximation: Representing Model Uncertainty in Deep Learning.

[2] cf. Gal, Y, J. Hron and A. Kendall (2017). Concrete Dropout.
...
- $\frac{1}{2} log \ \hat{\sigma}^2_i$ makes sure the network does not simply report high uncertainty everywhere.
